...
@layer components {
  ...
  .animate-fillIn { animation: fillIn 1.2s var(--qi-spring) forwards; }
  .animate-fadeUp { animation: fadeUp 0.5s ease 0.8s forwards; }
}
```
...
<!-- 迁移后 -->
<button class="inline-flex items-center justify-center w-8 h-8 p-0 bg-transparent 
...
*相关阅读：[可扩展的 CSS 架构：从 BEM 到设计令牌的演进](/blog/css-architecture-scalable-projects) —— 了解我们重构背后的方法论基础*

*相关阅读：[从零构建设计令牌系统](/blog/design-tokens-system-guide) —— 深入了解项目中使用的设计令牌系统*
