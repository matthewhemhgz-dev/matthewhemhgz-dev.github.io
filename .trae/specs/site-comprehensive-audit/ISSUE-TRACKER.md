...
### ISSUE-P3-006: 搜索建议缺少 ARIA listbox 角色 🟡 中优先级
...
### ISSUE-P3-010: 首页 PlatformsSection 缺少小红书和抖音 🟢 低优先级
...
### ISSUE-P3-012: Hero 统计数字动画可能引起 CLS 🟢 低优先级

**优先级**: P3 🟢  
**状态**: Open  
**类别**: 性能问题  
**影响范围**: 首页 Hero 区域  
**文件位置**: `src/components/sections/HeroSection.astro`
