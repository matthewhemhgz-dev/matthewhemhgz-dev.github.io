...
- **Given**: 网站添加了邮件订阅功能
- **When**: 用户填写并提交订阅表单
- **Then**: 用户收到确认邮件，订阅信息被正确存储
- **Verification**: `programmatic`
- **Notes**: 使用第三方邮件服务如Buttondown
...
- **Given**: 网站添加了评论系统
- **When**: 用户在博客文章页发表评论
- **Then**: 评论被正确显示，支持基本的评论管理
- **Verification**: `human-judgment`
- **Notes**: 使用基于GitHub Issues的Utterances或其他静态友好的评论系统
